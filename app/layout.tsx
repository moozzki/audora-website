...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || "https://zupericon.com"),
  title: {
    // Default ini bakal dipakai kalau halamannya nggak punya title sendiri (misal Homepage)
    default: "Zupericon - 3D Isometric Icon Generator",
    // Template ini bakal dipakai buat halaman lain. %s itu variabel buat nama halamannya.
    template: "%s | Zupericon - 3D Isometric Icon Generator",
  },
